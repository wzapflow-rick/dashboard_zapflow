...
- Name: bugs-regression.test.ts >> Bug Fixes - Regression Tests >> tutorial should fit in mobile viewport
- Location: tests\bugs-regression.test.ts:6:9
...
Call log:
  - waiting for locator('[data-testid="next-button"]')
