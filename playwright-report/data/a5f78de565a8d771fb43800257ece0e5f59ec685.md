...
- Name: bugs-regression.test.ts >> Bug Fixes - Regression Tests >> should create manual order without registration tab
- Location: tests\bugs-regression.test.ts:53:9
...
Call log:
  - waiting for locator('button:has-text("Novo Pedido")')
