...
-- Cliente: SABOR PERFEITO (hamburgueria) -> empresa_id = 25
...
-- 0.2 Lista as categorias dessa empresa (anote o id de "Hamburguer")
...
-- Localiza a categoria "Hamburguer" da empresa 25 automaticamente
