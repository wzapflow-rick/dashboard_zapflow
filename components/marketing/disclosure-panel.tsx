...
export default function DisclosurePanel() {
  ...
  return (
    <div className="flex flex-col gap-8">
          <header>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Divulgação do cardápio</h2>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Compartilhe seu cardápio digital e atraia mais clientes.</p>
          </header>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-violet-600 to-purple-600 p-8 text-white">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xl font-bold">Dicas para aumentar suas vendas</h3>
            </div>
