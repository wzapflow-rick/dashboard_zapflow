    ...
    return (
        ...
        <div className="space-y-8">
                    <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Campanhas automáticas</h2>
                            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Configure mensagens automáticas via WhatsApp para seus clientes.</p>
                        </div>
