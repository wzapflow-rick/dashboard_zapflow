                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto custom-scrollbar">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] sm:text-xs font-bold text-emerald-700 uppercase tracking-wider">
                                ...
                                />
                                <p className="text-[9px] text-slate-400 mt-1 font-medium leading-tight text-center">
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 sm:p-4">
                            <p className="text-[10px] sm:text-xs font-bold text-slate-700 uppercase tracking-wider mb-3">
                                Calcular custo por embalagem
                            </p>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <label className="text-[9px] text-slate-500 font-medium">Preço total pago</label>
                                    <input
                                        type="number"
                                        step="0.01"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[9px] text-slate-500 font-medium">Quantidade na embalagem</label>
                                    <input
                                        type="number"
                                        step="0.001"
                                ...
                                <div className="mt-3 pt-3 border-t border-slate-200">
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            if (custo > 0) {
                                                // Atualizar o campo custo_por_unidade via ref ou state
                                                // Vou usar um hack: alterar o valor do input pelo name
