...
export async function getReceitaDoProduto(produtoId: number) {
    try {
...
export async function saveReceitaDoProduto(produtoId: number, insumosList: { insumo_id: number, quantidade_necessaria: number }[]) {
    try {
